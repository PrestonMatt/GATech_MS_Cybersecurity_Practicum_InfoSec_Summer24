...
remove_strs = [
    ...
    "Gal.", "Lbs/Gal", "Inches", "Lb/Hr", "Flights", "Scalar", "DFN/%N1", "Hr-Min", "pf", "100 lb.", "Hr-Min"
    # Params:
...
dir_ = getcwd()
with open(r"C:\Users\mspre\Desktop\Practicum Resources\GATech_MS_Cybersecurity_Practicum_InfoSec_Summer24\Documentation\Labels\raw_BCD.txt","r") as fd:
    lines = fd.readlines()
    with open(dir_ + r"\bcd_processed.txt", "w") as b_fd:
        prev_line = ""
        new_line = ""
        label = ""
        for line in lines:
